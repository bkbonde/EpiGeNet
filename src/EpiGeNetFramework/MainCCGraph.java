...

{
	...
	public static enum RelTypes implements RelationshipType {
		HEALTHY, ADENOMA, CARCINOMA, METASTASIS, POLYPS, eNoEvent
	}

	public static enum LabelTypes implements Label {
		MolecularEvent, StartEvent
	}
	...
	void createDb() {
		...
		try (Transaction tx = graphDb.beginTx()) {
			...
			try {
				...
				ccGraph.readConditionalRelData();
				ccGraph.readSimpleRelData();
				System.out.println("generateStatistics");
				ccGraph.generateStatistics();
